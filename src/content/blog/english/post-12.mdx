...
keywords:
  [
    ...
    "my website is not bringing me leads",
    "getting leads for my website",
  ]
...
export const form = {
  ...
  inputs: [
    ...
    {
      label:
        "I agree to the terms and conditions and [privacy policy](/contact/).",
      id: "privacy-policy",
      name: "privacy_agreed",
      value: "Agreed",
      checked: false,
    ...
    },
    {
      ...
      content:
        "Something went wrong! Please email us directly at [info@bvswebdesign.co.uk](mailto:info@bvswebdesign.co.uk)",
    },
  ],
};
...
<div class="p-6 mt-8 bg-accent rounded-xl md:p-10">
  <h3 class="mb-6 text-2xl font-semibold text-white">Get In Touch</h3>
