---
enable: true
heading: "I can help if<span class='text-accent'>...</span>"
cards:
  ...
  - title: "You're paying too much for your current platform"
    body: "Proprietary website builders and closed CMS platforms can cost hundreds, sometimes thousands, a year for no good reason. I move businesses onto WordPress and cut the ongoing cost right down."
    target: "rescue"
  ...
  - title: "You're starting from scratch"
    body: "New business, new direction, or starting for the first time. I'll build something that brings the work in from day one."
    target: "design"
---
